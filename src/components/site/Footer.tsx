      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2 space-y-4">
          ...
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-2 rounded-full glass-dark hover:bg-primary/30 transition"
            >
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-navy-foreground/80">
            ...
            <li>
              <Link to="/services" className="hover:text-primary-glow">
                Services
              </Link>
            </li>
            <li>
              <Link to="/gallery" className="hover:text-primary-glow">
                Smile Gallery
              </Link>
            </li>
            <li>
              <Link to="/reviews" className="hover:text-primary-glow">
                Reviews
              </Link>
            </li>
            <li>
              <Link to="/blog" className="hover:text-primary-glow">
                Blog
              </Link>
            </li>
            <li>
              <Link to="/booking" className="hover:text-primary-glow">
                Book Appointment
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-navy-foreground/80">
            <li className="flex gap-2">
              ...
              <a href="tel:01783215958">01783-215958</a>
            </li>
            <li className="flex gap-2">
              <Mail className="h-4 w-4 mt-0.5 shrink-0 text-primary-glow" />
              <a href="mailto:abuhanifdnj@gmail.com">abuhanifdnj@gmail.com</a>
            </li>
            <li className="flex gap-2">
              <MapPin className="h-4 w-4 mt-0.5 shrink-0 text-primary-glow" />
              Law College Mor Mosque, Dinajpur, Bangladesh
            </li>
          </ul>
        </div>
      </div>
