  ...
  head: () => ({
    meta: [
      { title: "Dental Services | Hanif's Dental Dinajpur" },
      {
        name: "description",
        content:
          "Full-spectrum dental care: implants, root canal, orthodontics, cosmetic dentistry, smile design and more.",
      },
    ],
  }),
      ...
      <section className="pt-32 pb-16 bg-gradient-hero relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
            From preventive care to advanced cosmetic dentistry — every treatment delivered with
            ...
            >
              ...
              <div className="[direction:ltr]">
                ...
                <Button asChild variant="hero" size="lg" className="mt-8">
                  <Link to="/booking">
                    Book {s.name} <ArrowRight className="h-4 w-4" />
                  </Link>
                </Button>
              </div>
            </div>
